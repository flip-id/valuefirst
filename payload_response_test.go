			...
			fields: func() fields {
				return fields{
					...
					Error: &ResponseMessageAckError{
						...
						Code:        newtype.IntString(ErrCodeGeneralNotConformDTD),
					},
				}
			},
			wantErr: true,
				...
				return fields{
					GUID: &ResponseMessageAckGUID{
						...
						Error: &ResponseMessageAckGUIDError{
							Code:     newtype.IntString(ErrCodeMessageInvalidSenderID),
							Sequence: "1",
						},
						ID: "1",
					},
				...
				return fields{
					GUID: &ResponseMessageAckGUID{
						...
						Error: &ResponseMessageAckGUIDErrors{
							...
							{
								Code:     newtype.IntString(ErrCodeMessageInvalidMessage),
								Sequence: "2",
							},
						},
						ID: "1",
			...
			fields: func() fields {
				return fields{
					GUID: &ResponseMessageAckGUID{
						...
						SubmitDate: "2018-02-14 12:39:51",
						Error: &ResponseMessageAckGUIDError{
							Code:     newtype.IntString(ErrCodeSchedulerSuccess),
							Sequence: "1",
						},
						ID: "1",
					},
				...
				return fields{
					GUID: &ResponseMessageAckGUID{
						...
						Error: &ResponseMessageAckGUIDErrors{
							...
							{
								Code:     newtype.IntString(ErrCodeGeneralSuccess),
								Sequence: "2",
							},
							{
								Code:     newtype.IntString(ErrCodeStatusRequestSuccess),
								Sequence: "3",
							},
						},
						ID: "1",
