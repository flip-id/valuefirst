			...
			fields: func() fields {
				return fields{
					...
					Error: &ResponseMessageAckError{
						...
						Code:        newtype.String(ErrCodeGeneralNotConformDTD),
					},
				}
			},
			wantErr: true,
				...
				return fields{
					GUID: &ResponseMessageAckGUID{
						...
						Error: &ResponseMessageAckGUIDError{
							Code:     newtype.String(ErrCodeMessageInvalidSenderID),
							Sequence: "1",
						},
						ID: "1",
					},
				...
				return fields{
					GUID: &ResponseMessageAckGUID{
						...
						Error: &ResponseMessageAckGUIDErrors{
							...
							{
								Code:     newtype.String(ErrCodeMessageInvalidMessage),
								Sequence: "2",
							},
						},
						ID: "1",
			...
			fields: func() fields {
				return fields{
					GUID: &ResponseMessageAckGUID{
						...
						SubmitDate: "2018-02-14 12:39:51",
						Error: &ResponseMessageAckGUIDError{
							Code:     newtype.String(ErrCodeSchedulerSuccess),
							Sequence: "1",
						},
						ID: "1",
					},
				...
				return fields{
					GUID: &ResponseMessageAckGUID{
						...
						Error: &ResponseMessageAckGUIDErrors{
							...
							{
								Code:     newtype.String(ErrCodeGeneralSuccess),
								Sequence: "2",
							},
							{
								Code:     newtype.String(ErrCodeStatusRequestSuccess),
								Sequence: "3",
							},
						},
						ID: "1",
